...
namespace Mono.Debugger.Interface
{
	...
	public struct TargetAddress : IComparable
	{
		...
		// </summary>
		public TargetAddress (IAddressDomain domain, long address)
		{
			this.domain = domain;
			// FIXME: hack
		...
		public TargetAddress (IAddressDomain domain, IRegister register)
